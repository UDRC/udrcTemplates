...
## Introduction
<!-- \twocol switches to two column mode... \onecol can be used to switch back to one column -->
\twocol 
...
\onecol
\maketable{Table 1: Large Table Example}
...
\maketable{Table 2: Small Table Example}
``` {r, echo=FALSE, results='asis', warning = FALSE}
